...
extension NSDate {
    ...
    private func today() -> Bool {
        ...
        return formatterDate.stringFromDate(NSDate()) == formatterDate.stringFromDate(self) ? true : false
    }
    ...
    private func yesterday() -> Bool {
        ...
        return formatterDate.stringFromDate(yesterdayDate!) == formatterDate.stringFromDate(self) ? true : false
    }
